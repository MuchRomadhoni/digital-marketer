<nav class="navbar-1-1 navbar fixed-top navbar-expand-lg navbar-light px-md-4 bg-body navbar-fixed-top" style="
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="main-navbar">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-md-4" href="#digital-agency">Digital Agency</a>
                        </li>
                        <li class="nav-item">
